...
class AddCommentHandler(BaseHandler):
	...
	def post(self):
		...
		object_id = self.get_argument(CommonConstants.USERNAME) + BoardConstants.COMMENT + DateUtil.get_time_now()
		...
		res["status"] = "ok"
		res["data"] = {BoardConstants.COMMENT: comment, BoardConstants.USER: user}
